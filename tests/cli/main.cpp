...
struct cli_fixture
{
   ...
   cli_fixture() :
      ...
      nathan_keys( {"5K2oKcPvqu9dmt8EwLEF7KghJamEk1npeQa9nm8gQjuxPisybxy"} )
   {
      ...
      try
      {
         ...
         BOOST_CHECK_EQUAL(nathan_keys[0], "5K2oKcPvqu9dmt8EwLEF7KghJamEk1npeQa9nm8gQjuxPisybxy");
...
BOOST_FIXTURE_TEST_CASE( create_new_account, cli_fixture )
{
   try
   {
      ...
      BOOST_TEST_MESSAGE("Transferring AcloudBank from nathan to jmjatlanta");
...
BOOST_AUTO_TEST_CASE( cli_multisig_transaction )
{
   ...
   try {
      ...
      // import nathan account
      BOOST_TEST_MESSAGE("Importing nathan key");
      std::vector<std::string> nathan_keys{"5K2oKcPvqu9dmt8EwLEF7KghJamEk1npeQa9nm8gQjuxPisybxy"};
      BOOST_CHECK_EQUAL(nathan_keys[0], "5K2oKcPvqu9dmt8EwLEF7KghJamEk1npeQa9nm8gQjuxPisybxy");
      BOOST_CHECK(con.wallet_api_ptr->import_key("nathan", nathan_keys[0]));
      ...
      BOOST_TEST_MESSAGE("Transferring AcloudBank from nathan to cifer.test");
...
BOOST_AUTO_TEST_CASE( cli_create_htlc )
{
   ...
   try {
      ...
      // create a new account for Alice
      {
         ...
         BOOST_TEST_MESSAGE("Transferring AcloudBank from nathan to alice");
      ...
      // create a new account for Bob
      {
         ...
         BOOST_TEST_MESSAGE("Transferring AcloudBank from nathan to Bob");
