...
try {
   ...
   const asset_id_type uia_id = create_user_issued_asset( "RSQRCHP1COIN", nathan, transfer_restricted).id;
...
try {
   ...
   // create a UIA
   const asset_id_type uia_id = create_user_issued_asset( "RSQRCHP1COIN", nathan, white_list ).id;
