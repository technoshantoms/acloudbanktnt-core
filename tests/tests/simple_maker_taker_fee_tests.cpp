...
BOOST_FIXTURE_TEST_SUITE(simple_maker_taker_fee_tests, simple_maker_taker_database_fixture)
   ...
   BOOST_AUTO_TEST_CASE(default_taker_fees) {
      try {
         ...
         create_user_issued_asset("RSQRCHP11COIN", nathan, charge_market_fee, price, 2,
                                                                  nathan1coin_market_fee_percent);

         const uint16_t nathan2coin_market_fee_percent = 2 * GRAPHENE_1_PERCENT;
         create_user_issued_asset("RSQRCHP12COIN", nathan, charge_market_fee, price, 2,
         ...
         // Obtain asset object after a block is generated to obtain the final object that is commited to the database
         generate_block();
         const asset_object& nathan1coin = get_asset("RSQRCHP11COIN");
         const asset_object& nathan2coin = get_asset("RSQRCHP12COIN");
